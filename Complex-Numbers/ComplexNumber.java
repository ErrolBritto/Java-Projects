...
return imag; //A stub: to be fixed
}
/**
...
return new ComplexNumber(-real,-imag); //A stub: to be fixed
}
/**
...
return new ComplexNumber ((this.real + z.real), (this.imag + z.imag)); //A stub: to be fixed
}
/**
* Returns a new ComplexNumber that is the
...
public ComplexNumber multiply(ComplexNumber z) {
 ...
 return new ComplexNumber((real*z.real) - (imag*z.imag), (real*z.imag) + (imag*z.real));
 //A stub: to be fixed
...
double size = (real*real) +(imag*imag);
    return new ComplexNumber ( real/size, -imag/size ); //A stub: to be fixed
}
/**
* Returns a new ComplexNumber that is
...
return new ComplexNumber ((this.real*z.real+this.imag*z.imag)/div, (this.imag*z.real-this.real*z.imag)/div);  //A stub: to be fixed
}
/**
